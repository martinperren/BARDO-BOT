	...
	*/
	...
	try {
		...
		// {... DO WHAT YOU NEED TO WITH THE ERROR CAUGHT BY EITHER Asynchronous OR Synchronous part of the method ...}
			...
			embed.addField(data.participants[i].summonerName + " " + getChampionName(data.participants[i].championId), tierSD + " " + rankSD + " " + lp + "PL", true)/*.addBlankField(true)*/
